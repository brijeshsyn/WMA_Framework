...
public class ScreenShot {
	...
	public static String getScreenShot(String strAction) {
		...
		String location = ConfigProvider.getInstance().getScreenFolder() + System.getProperty("file.separator") 
	...
	public static String getwebElemenstShot(String strAction, String screenshotPath, WebElement element)
		...
		BufferedImage dest = img.getimage(p.getX(), p.getY(), width, height);
